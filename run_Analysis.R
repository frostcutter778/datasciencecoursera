pathdata = file.path("C://Users//user//Desktop//datasciencecoursera", "UCI HAR Dataset")
...
# Next step is reading all the values that are available
...
#The last step is writing the ouput to a text file 
